...
if ( ! class_exists( 'MoreNews_Info' ) ) {
    ...
    class MoreNews_Info {
         ...
         * Single instance.
         *
         * @var MoreNews_Info $instance Instance object.
         */
        ...
        public static function init( $config ) {
            if ( ! isset( self::$instance ) && ! ( self::$instance instanceof MoreNews_Info ) ) {
                self::$instance = new MoreNews_Info;
        ...
        public function configure() {
            ...
            $this->notice        = '<p>' . sprintf( esc_html__( 'Welcome! Thank you for choosing %1$s. To fully take advantage of the best our theme can offer please make sure you visit theme details page.', 'morenews' ), esc_html( $this->theme_name ) ) . '</p><p><a href="' . esc_url( $this->page_url ) . '" class="button button-primary">' . sprintf( esc_html__( 'Get started with %1$s', 'morenews' ), $this->theme_name ) . '</a><a href="#" class="btn-dismiss" data-userid="' . esc_attr( get_current_user_id() ) . '" data-nonce="' . esc_attr( wp_create_nonce( 'morenews_dismiss_nonce' ) ) . '">' . esc_html__( 'Dismiss this notice', 'morenews' ) . '</a></p>';
        }
        ...
        public function hooks() {
            ...
            // Dismiss AJAX.
            add_action( 'wp_ajax_morenews_dismiss', array( $this, 'dismiss_callback' ) );
            add_action( 'wp_ajax_nopriv_morenews_dismiss', array( $this, 'dismiss_callback' ) );
        }
        ...
        public function render_current_tab_content() {
            ...
            if ( method_exists( $this, $method ) ) {
                ...
                printf( esc_html__( '%s() method does not exist.', 'morenews' ), $method );
            }
        }
        ...
        public function useful_plugins() {
            ...
            <div class="aft-section aft-section-useful-plugins">
                ...
                <?php if ( true !== $tgmpa_complete ) : ?>
                    <a href="<?php echo esc_url( $tgmpa_url ); ?>" class="button button-primary"><?php esc_html_e( 'Manage Plugins', 'morenews' ); ?></a>
                <?php endif; ?>
                ...
                <div class="compare-table table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th class="db-bk-color-one"><?php _e('Product Features', 'morenews'); ?></th>
                            <th class="db-bk-color-two"><?php _e('Free', 'morenews'); ?></th>
                            <th class="db-bk-color-two"><?php _e('Premium', 'morenews'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
        ...
        public function assets( $hook ) {
            ...
            if ( in_array( $hook, array( 'themes.php', 'appearance_page_' . $this->page_slug ), true ) ) {
                wp_enqueue_style( 'morenews-info', get_template_directory_uri() . '/lib/info/css/info.css', array(), '1.0.0' );
                wp_enqueue_script( 'morenews-info', get_template_directory_uri() . '/lib/info/js/info' . $min . '.js', array(), '1.0.0' );
            }
        ...
        public function display_admin_notice() {
            ...
            $dismiss_status = get_user_meta( $user_id, 'morenews_dismiss_status', true );
            ?>
        ...
        public function dismiss_callback() {
            ...
            if ( false === wp_verify_nonce( $wpnonce, 'morenews_dismiss_nonce' ) ) {
                wp_send_json( $output );
            }

            update_user_meta( $userid, 'morenews_dismiss_status', 1 );
