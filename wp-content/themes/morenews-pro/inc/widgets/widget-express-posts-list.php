...
if (!class_exists('MoreNews_Express_Posts_List')) :
    ...
    class MoreNews_Express_Posts_List extends MoreNews_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $morenews_no_of_post = !empty($instance['morenews-number-of-posts']) ? $instance['morenews-number-of-posts'] : 5;
            ...
            <section class="aft-blocks aft-featured-category-section af-list-post featured-cate-sec pad-v">
                <?php $morenews_featured_express_posts_one = morenews_get_posts($morenews_no_of_post, $morenews_category); ?>
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::morenews_generate_text_input('morenews-number-of-posts', __('Number of posts', 'morenews'), '5');
