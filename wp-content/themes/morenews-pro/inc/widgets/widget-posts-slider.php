...
if (!class_exists('MoreNews_Posts_Slider')) :
    ...
    class MoreNews_Posts_Slider extends MoreNews_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $number_of_posts = isset($instance['morenews-number-of-posts']) ? $instance['morenews-number-of-posts'] : 5;
                ...
                <div class="af-slider-wrap">
                    ...
                    <div class="widget-block widget-wrapper af-widget-body">
                        <div class="af-posts-slider af-widget-post-slider posts-slider banner-slider-2  af-posts-slider af-widget-carousel af-cat-widget-carousel slick-wrapper">
                            <?php
                                $morenews_slider_posts = morenews_get_posts($number_of_posts, $morenews_category);
