    ...
    if (!class_exists('MoreNews_Featured_Post')) :
        ...
        class MoreNews_Featured_Post extends MoreNews_Widget_Base
        {
            ...
            public function widget($args, $instance)
            {
                ...
                $morenews_number_of_featured_news = !empty($instance['morenews-number-of-posts']) ? $instance['morenews-number-of-posts'] :6;
            ...
            public function form($instance)
            {
                ...
                if (isset($categories) && !empty($categories)) {
                    ...
                    echo parent::morenews_generate_text_input('morenews-number-of-posts', __('Number of posts', 'morenews'), '6');
