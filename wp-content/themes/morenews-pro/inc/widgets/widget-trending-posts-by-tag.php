<?php
    ...
    if (!class_exists('MoreNews_Trending_Posts_By_Tag')) :
        /**
         * Adds MoreNews_Prime_News widget.
         */
        class MoreNews_Trending_Posts_By_Tag extends MoreNews_Widget_Base
        {
            /**
            ...
            function __construct()
            {
                ...
                parent::__construct('morenews_trending_news_by_tag', __('AFTMN Trending News (By Tag)', 'morenews'), $widget_ops);
            }
            ...
            public function widget($args, $instance)
            {
                ...
                $morenews_no_of_post = !empty($instance['morenews-number-of-posts']) ? $instance['morenews-number-of-posts'] :7;
                $morenews_trending_news_category = !empty($instance['morenews-select-category']) ? $instance['morenews-select-category'] : '0';
                ...
                if (!empty($morenews_trending_news_section_title)) { ?>
                    <?php morenews_render_section_title($morenews_trending_news_section_title); ?>
                <?php }
                ?>
                <div class="slick-wrapper af-trending-widget-carousel af-trending-by-tag-widget-carousel af-post-carousel-list banner-vertical-slider af-widget-carousel af-widget-body">
                        ...
                        <?php
                           ...
                           $morenews_filterby = 'tag';
                            ...
                            $morenews_featured_posts = morenews_get_posts($morenews_number_of_posts, $morenews_trending_news_category, $morenews_filterby);
            ...
            public function form($instance)
            {
                ...
                $categories = morenews_get_terms(0,'post_tag');
                
                echo parent::morenews_generate_text_input('morenews-trending-news-title', __('Title', 'morenews'), 'Trending News');
                                echo parent::morenews_generate_select_options('morenews-select-category', __('Select Tag', 'morenews'), $categories);
