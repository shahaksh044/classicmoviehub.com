...
if (!class_exists('MoreNews_Posts_lists')) :
    ...
    class MoreNews_Posts_lists extends MoreNews_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $morenews_no_of_post = !empty($instance['morenews-posts-slider-number']) ? $instance['morenews-posts-slider-number'] :6;
            ...
            ?>
                <section class="aft-blocks aft-featured-category-section af-list-post featured-cate-sec pad-v">
                    ...
                    <?php endif; ?>
                    <?php $morenews_all_posts_vertical = morenews_get_posts($morenews_no_of_post, $morenews_category); ?>
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::morenews_generate_text_input('morenews-posts-slider-number', __('Number of posts', 'morenews'), '6');
