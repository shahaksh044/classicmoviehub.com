<?php
    ...
    if (!class_exists('MoreNews_Trending_Posts_By_View')) :
        /**
         * Adds MoreNews_Prime_News widget.
         */
        class MoreNews_Trending_Posts_By_View extends MoreNews_Widget_Base
        {
            /**
            ...
            function __construct()
            {
                ...
                parent::__construct('morenews_trending_news_by_view', __('AFTMN Trending News (By View)', 'morenews'), $widget_ops);
            }
