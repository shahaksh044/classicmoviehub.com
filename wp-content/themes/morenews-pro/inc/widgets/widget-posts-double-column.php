...
if (!class_exists('MoreNews_Express_Posts_Double_Column')) :
    ...
    class MoreNews_Express_Posts_Double_Column extends MoreNews_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $morenews_no_of_post = !empty($instance['morenews-posts-slider-number']) ? $instance['morenews-posts-slider-number'] : 3;
                ...
                <div class="af-container-row pad-v clearfix">
                    ...
                    foreach ($morenews_featured_categories as $morenews_fc): ?>
                        <div class="col-2 pad float-l af-sec-post">
                            ...
                            <?php $morenews_all_posts_vertical = morenews_get_posts($morenews_no_of_post, $morenews_fc[0]); ?>
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::morenews_generate_text_input('morenews-posts-slider-number', __('Number of posts', 'morenews'), '3');
