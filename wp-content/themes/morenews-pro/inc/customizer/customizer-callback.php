...
if (!function_exists('morenews_main_banner_3_col_section_status')) :
    ...
    function morenews_main_banner_3_col_section_status($control)
    {
        ...
        if (('layout-1' == $control->manager->get_setting('select_main_banner_layout_section')->value()) || ('layout-2' == $control->manager->get_setting('select_main_banner_layout_section')->value()) || ('layout-3' == $control->manager->get_setting('select_main_banner_layout_section')->value())) {
            return true;
        } else {
            return false;
        }
...
if (!function_exists('morenews_main_banner_2_col_section_status')) :
    ...
    function morenews_main_banner_2_col_section_status($control)
    {
        ...
        if (('layout-4' == $control->manager->get_setting('select_main_banner_layout_section')->value()) || ('layout-5' == $control->manager->get_setting('select_main_banner_layout_section')->value()) || ('layout-6' == $control->manager->get_setting('select_main_banner_layout_section')->value())) {
            return true;
        } else {
            return false;
        }
...
if (!function_exists('morenews_main_banner_2_col_2_row_section_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function morenews_main_banner_2_col_2_row_section_status($control)
    {

        if (('layout-0' == $control->manager->get_setting('select_main_banner_layout_section')->value())) {
            return true;
        } else {
            return false;
        }
    ...
    if (!function_exists('morenews_main_banner_layout_trending_status')) :
        ...
        function morenews_main_banner_layout_trending_status($control)
        {
            ...
            if ('layout-0' == $control->manager->get_setting('select_main_banner_layout_section')->value() || 'layout-2' == $control->manager->get_setting('select_main_banner_layout_section')->value() || 'layout-3' == $control->manager->get_setting('select_main_banner_layout_section')->value()|| 'layout-6' == $control->manager->get_setting('select_main_banner_layout_section')->value()) {
                return true;
            } else {
                return false;
            }
...
if (!function_exists('morenews_main_banner_layout_tabs_status')) :
    ...
    if (!function_exists('morenews_main_banner_layout_editor_picks_status')) :
        ...
        function morenews_main_banner_layout_editor_picks_status($control)
        {
            ...
            if ('layout-0' == $control->manager->get_setting('select_main_banner_layout_section')->value() || 'layout-1' == $control->manager->get_setting('select_main_banner_layout_section')->value() || 'layout-2' == $control->manager->get_setting('select_main_banner_layout_section')->value() || 'layout-4' == $control->manager->get_setting('select_main_banner_layout_section')->value()) {
                return true;
            } else {
                return false;
            }
...
/*select page for slider*/
if (!function_exists('morenews_aft_custom_icon_mode_status')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function morenews_aft_custom_icon_mode_status($control)
    {

        if ( 'aft-custom-fa-icon' == $control->manager->get_setting('aft_custom_icon_mode')->value()) {
            return true;
        } else {
            return false;
        }
