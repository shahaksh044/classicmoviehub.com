...
if (!function_exists('morenews_get_default_theme_options')) :
    ...
    function morenews_get_default_theme_options()
    {
        ...
        $defaults['aft_custom_icon_mode']           = 'aft-custom-ripple';
        ...
        $defaults['footer_background_color']  = '#404040';
        ...
        $morenews_google_fonts = array(
            ...
            'Bangers'                                   => 'Bangers',
            'Barlow:400,400i,500,500i,700,700i'         => 'Barlow',
            'BenchNine:400,700'                         => 'BenchNine',
            'Bevan'                                     => 'Bevan',
            'Bitter:400,400italic,700'                  => 'Bitter',
            'Black+Han+Sans:400,700'                    => 'Black Han Sans',
            ...
            'Nanum+Gothic:400,700'                      => 'Nanum Gothic',
            ...
            'Noto+Sans+Bengali:400,700'                 => 'Noto Sans Bengali',
            'Noto+Sans+JP:400,700'                      => 'Noto Sans JP',
            'Noto+Sans+SC:400,700'                      => 'Noto Sans SC',
            'Noto+Sans+TC:400,700'                      => 'Noto Sans TC',
            'Noto+Sans+KR:400,700'                      => 'Noto Sans KR',
            'Noto+Serif:400,400italic,700'              => 'Noto Serif',
            'Noto+Serif+Bengali:400,400italic,700'      => 'Noto Serif Bengali',
            'Noto+Serif+JP:400,400italic,700'           => 'Noto Serif JP',
            'Noto+Serif+SC:400,400italic,700'           => 'Noto Serif SC',
            'Noto+Serif+TC:400,400italic,700'           => 'Noto Serif TC',
            ...
            'ZCOOL+XiaoWei:400,700'                     => 'ZCOOL XiaoWei',
        );
        ...
        $defaults['title_line_height']  = 1.5;
