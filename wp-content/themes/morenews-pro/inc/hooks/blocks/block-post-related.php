...
<div class="promotionspace enable-promotionspace">
    <div class="af-reated-posts morenews-customizer">
        <?php
            ...
            $morenews_related_section_title = esc_attr(morenews_get_option('single_related_posts_title'));
            $morenews_number_of_related_posts = esc_attr(morenews_get_option('single_number_of_related_posts'));
