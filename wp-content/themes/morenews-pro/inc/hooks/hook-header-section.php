...
if (!function_exists('morenews_header_section')) :
    ...
    function morenews_header_section()
    {
        ...
        <header id="masthead" class="<?php echo esc_attr($morenews_header_layout); ?> morenews-header">
            <?php
            if ($morenews_header_layout == 'header-layout-centered') {
                morenews_get_block('layout-centered', 'header');

            } else if ($morenews_header_layout == 'header-layout-compressed-full') {
                morenews_get_block('layout-compressed', 'header');

            } else {
                morenews_get_block('layout-default', 'header');
            }
            ?>
...
if (!function_exists('morenews_load_watch_online_section')):
    ...
    function morenews_load_watch_online_section()
    {
        ...
        if ($morenews_aft_enable_custom_link):
            ...
            $morenews_aft_custom_icon_mode = morenews_get_option('aft_custom_icon_mode');
            ...
            if (!empty($morenews_aft_custom_title)):
                ?>
                <div class="custom-menu-link <?php echo esc_attr($morenews_aft_custom_icon_mode);?>">
