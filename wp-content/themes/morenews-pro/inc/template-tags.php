            ...
            if ($morenews_display_date): ?>
                <span class="item-metadata posts-date">
                    <i class="far fa-clock" aria-hidden="true"></i>
                        ...
                        } elseif ($morenews_date_display_setting == 'year-and-month') {
                            the_time('F Y');
                        } elseif ($morenews_date_display_setting == 'month-and-day') {
                            the_time('jS M');
                        } elseif ($morenews_date_display_setting == 'year') {
                            the_time('Y');
                        } elseif ($morenews_date_display_setting == 'month') {
                            the_time('F');
                        } elseif ($morenews_date_display_setting == 'day') {
                            the_time('l');
                        } elseif ($morenews_date_display_setting == '24-hours') {
                            the_time('H:i A');
                        } elseif ($morenews_date_display_setting == '12-hours') {
                            the_time('H:i a');
                        } else {
