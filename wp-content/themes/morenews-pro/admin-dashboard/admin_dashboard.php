...
if (!class_exists('AF_themes_info')) {
  class AF_themes_info
  {
    ...
    public function morenews_body_classes($classes)
    {
    ...
    public function morenews_register_info_page()
    {
      ...
      // Add info page.
      $get_started_slug = 'morenews-pro';
      $get_started_order = 1;
      $templatespare_status = false;
      $starter_sites_slug = 'starter-sites';
      ...
      add_menu_page(
        __('MoreNews Pro', 'morenews'), // Page Title.
        __('MoreNews Pro', 'morenews'), // Menu Title.
        'edit_posts', // Capability.
        'morenews-pro', // Menu slug.
      ...
      add_submenu_page(
        'morenews-pro', // Parent slug.
        __('Support', 'morenews'), // Page title.
        __('Support', 'morenews'), // Menu title.
        'manage_options', // Capability.
      ...
      add_submenu_page(
        'morenews-pro', // Parent slug.
        __('BFCM Offers', 'morenews'), // Page title.
        '<span id="aft-upgrade-menu-item">' . __('BFCM Offers', 'morenews') .'</span>', // Menu title.
        'manage_options', // Capability.
    ...
    public function morenews_render_starter_templates()
    {
      ...
      <?php
        ...
        if (!empty($morenews_blockspare_verison) && $morenews_blockspare_active && $morenews_blockspare_verison < $morenews_blockspare_old_version) {
          ...
          $class = 'false';
          $message = __('One-click Import, No Coding Hassle!', 'morenews');
        }
...
<?php
    ...
    public function morenews_render_templates_kits()
    {
      ...
      if (!empty($morenews_elespare_installed) && $morenews_check_elespare == 'pro') {
        ...
        $morenews_elespare_old_version = '2.2.0';
      ...
      if (($morenews_elespare_installed && $morenews_elespare_active) && $plugin_update == 'false' && is_plugin_active($morenews_elementor_installed)) {
        ...
        $message = (!empty($morenews_elespare_verison) && $morenews_elespare_active && $morenews_elespare_verison < $morenews_elespare_old_version)
          ...
          : __('One-click Import, No Coding Hassle!', 'morenews');
    ...
    public function morenews_register_backend_scripts()
    {
    ...
    public function morenews_get_latest_changelog()
    {
      $readme = null;
    ...
    public function morenews_get_plugins_list_data()
    {
      ...
      if (empty($activate_plugins) && empty($install_plugin)) {
        $btn_class = '';
        $morenews_templatespare_url = site_url() . '/wp-admin/admin.php?page=morenews-pro';
