            ...
            <main id="main" class="site-main">
                ...
                while (have_posts()) : the_post(); ?>
                    <article id="post-<?php the_ID(); ?>" <?php post_class('af-single-article'); ?>>
                        ...
                        <?php if (is_active_sidebar('single-below-posts-content-advertisement-widgets')): ?>
                            <div class="single-posts-promotions">
                                <?php dynamic_sidebar('single-below-posts-content-advertisement-widgets'); ?>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php
                        $show_mailchimp = morenews_get_option('single_show_mailchimp_subscriptions');
                        ...
                        <?php
                        $show_trending_posts = morenews_get_option('single_show_trending_post_list');
                        if ($show_trending_posts):
                            if ('post' === get_post_type()) :
                                morenews_get_block('trending');
                            endif;
                        endif;
                        ?>
